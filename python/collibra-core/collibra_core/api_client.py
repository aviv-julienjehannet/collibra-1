...
from collibra_core.exceptions import ApiTypeError, ApiValueError, ApiException
from collibra_core.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ActivitiesApi()
        api_instance.get_activities  # this is an instance of the class Endpoint
        api_instance.get_activities()  # this invokes api_instance.get_activities.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_activities.callable or self.callable in this class
