...
class ChangeWorkflowDefinitionRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'candidate_user_check_disabled': (bool,),  # noqa: E501
            'candidate_user_check_enabled': (bool,),  # noqa: E501
            'global_create': (bool,),  # noqa: E501
            'enable': (bool,),  # noqa: E501
            'start_label': (str,),  # noqa: E501
            'start_role_ids': ([str],),  # noqa: E501
            'stop_role_ids': ([str],),  # noqa: E501
            'reassign_role_ids': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'candidate_user_check_disabled': 'candidateUserCheckDisabled',  # noqa: E501
        ...
        'start_role_ids': 'startRoleIds',  # noqa: E501
        'stop_role_ids': 'stopRoleIds',  # noqa: E501
        'reassign_role_ids': 'reassignRoleIds',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ChangeWorkflowDefinitionRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): The name of the workflow definition.. [optional]  # noqa: E501
            description (str): The new description for the workflow definition.. [optional]  # noqa: E501
            configuration_variables ({str: (str,)}): The configuration variables.. [optional]  # noqa: E501
            start_events ([str]): The list of workflow start event types.. [optional]  # noqa: E501
            business_item_resource_type (str): The type of the business item corresponding to the workflow.. [optional]  # noqa: E501
            exclusivity (str): Defines the number of times a resource workflow is able to be start.. [optional]  # noqa: E501
            guest_user_accessible (bool): [optional]  # noqa: E501
            registered_user_accessible (bool): Whether the workflow should be accessible by the registered user.. [optional]  # noqa: E501
            candidate_user_check_disabled (bool): Whether the candidate user check for the workflow should be disabled.. [optional]  # noqa: E501
            candidate_user_check_enabled (bool): Whether the candidate user check for the workflow should be enabled.. [optional]  # noqa: E501
            global_create (bool): Whether the workflow is accessible from the global create menu.. [optional]  # noqa: E501
            enable (bool): Whether the workflow definition should be enabled.. [optional]  # noqa: E501
            start_label (str): The start label of the workflow.. [optional]  # noqa: E501
            start_role_ids ([str]): The list of IDs identifying the roles allowing to start the workflow.. [optional]  # noqa: E501
            stop_role_ids ([str]): The list of IDs identifying the roles allowing to stop the workflow.. [optional]  # noqa: E501
            reassign_role_ids ([str]): The list of IDs identifying the roles allowing to reassign the workflow.. [optional]  # noqa: E501
        """
