...
class ChangeUserRequest(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ChangeUserRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            enabled (bool): The new enabled flag for the user. [optional]  # noqa: E501
            username (str): The new username for the user. [optional]  # noqa: E501
            first_name (str): The new first name for the user. [optional]  # noqa: E501
            last_name (str): The new last name for the user. [optional]  # noqa: E501
            email (str): The new e-mail address for the user. [optional]  # noqa: E501
            gender (str): The new gender for the user. [optional]  # noqa: E501
            language (str): The new language for the user. [optional]  # noqa: E501
