...
class SetAssetResponsibilitiesRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, role_id, owner_ids, *args, **kwargs):  # noqa: E501
        """SetAssetResponsibilitiesRequest - a model defined in OpenAPI
