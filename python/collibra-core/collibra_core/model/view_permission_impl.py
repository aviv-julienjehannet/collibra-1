...
class ViewPermissionImpl(ModelNormal):
    ...
    attribute_map = {
        ...
        'user_group_id': 'userGroupId',  # noqa: E501
    ...
    def __init__(self, id, resource_type, *args, **kwargs):  # noqa: E501
        """ViewPermissionImpl - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            user_id (str): ID of the user that is the owner of this ViewPermission, if the owner is a user. [optional]  # noqa: E501
            user_group_id (str): ID of the UserGroup that is the owner of this ViewPermission, if the owner is a group. [optional]  # noqa: E501
            base_resource (ResourceReference): [optional]  # noqa: E501
        """
