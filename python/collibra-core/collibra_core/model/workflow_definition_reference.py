...
class WorkflowDefinitionReference(ModelNormal):
    ...
    def __init__(self, id, resource_type, *args, **kwargs):  # noqa: E501
        """WorkflowDefinitionReference - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            process_id (str): The <code>id</code> of the process corresponding to the workflow.. [optional]  # noqa: E501
        """
