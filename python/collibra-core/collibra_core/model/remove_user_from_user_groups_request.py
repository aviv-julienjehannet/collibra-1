...
class RemoveUserFromUserGroupsRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, user_group_ids, *args, **kwargs):  # noqa: E501
        """RemoveUserFromUserGroupsRequest - a model defined in OpenAPI
