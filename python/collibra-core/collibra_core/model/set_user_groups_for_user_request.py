...
class SetUserGroupsForUserRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_group_ids, *args, **kwargs):  # noqa: E501
        """SetUserGroupsForUserRequest - a model defined in OpenAPI
