...
class ChangeRoleRequest(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): The new name for the role. Should be unique within all roles.. [optional]  # noqa: E501
            description (str): The new description for the role.. [optional]  # noqa: E501
            permissions ([str]): The new permissions to be set. If null, no changes are made, otherwise the current permissions are<br/>replaced with the given ones.. [optional]  # noqa: E501
        """
