...
class ComplexRelationLegRequest(ModelNormal):
    ...
    attribute_map = {
        'leg_type_id': 'legTypeId',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, leg_type_id, asset_id, *args, **kwargs):  # noqa: E501
        """ComplexRelationLegRequest - a model defined in OpenAPI
