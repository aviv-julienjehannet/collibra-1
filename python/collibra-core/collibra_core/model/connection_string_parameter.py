...
class ConnectionStringParameter(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, label, parameter, *args, **kwargs):  # noqa: E501
        """ConnectionStringParameter - a model defined in OpenAPI
