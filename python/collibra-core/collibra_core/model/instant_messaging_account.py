...
class InstantMessagingAccount(ModelNormal):
    ...
    def __init__(self, id, resource_type, *args, **kwargs):  # noqa: E501
        """InstantMessagingAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            account (str): The string representing the account (for example the Skype ID).. [optional]  # noqa: E501
            type (str): The type of instant messaging account.. [optional]  # noqa: E501
        """
