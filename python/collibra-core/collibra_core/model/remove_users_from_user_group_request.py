...
class RemoveUsersFromUserGroupRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_group_id, user_ids, *args, **kwargs):  # noqa: E501
        """RemoveUsersFromUserGroupRequest - a model defined in OpenAPI
