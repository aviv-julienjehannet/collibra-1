...
class AddResponsibilityRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, role_id, owner_id, *args, **kwargs):  # noqa: E501
        """AddResponsibilityRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            resource_id (str): The ID of the resource which the responsibility is created for. NOTE: if null, a global responsibility is created.. [optional]  # noqa: E501
            resource_type (str): The type of the resource which the responsibility is created for, i.e. [Community, Asset, Domain].. [optional]  # noqa: E501
        """
