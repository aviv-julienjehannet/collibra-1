...
class AddRoleRequest(ModelNormal):
    ...
    def __init__(self, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The ID of the new role. Should be unique within all roles<br/><p><br/>It should have a format of universally unique identifier (UUID) and should not start<br/>with <code>00000000-0000-0000-</code> which is a reserved prefix.. [optional]  # noqa: E501
            _global (bool): Whether the role should be a global or resource role.. [optional]  # noqa: E501
            description (str): The description of the role.. [optional]  # noqa: E501
            permissions ([str]): The permissions to be granted for this role.. [optional]  # noqa: E501
        """
