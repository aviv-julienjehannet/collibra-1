...
# **add_domain_type**
> DomainTypeImpl add_domain_type()
...
from collibra_core.api import domain_types_api
...
with collibra_core.ApiClient(configuration) as api_client:
    ...
    api_instance = domain_types_api.DomainTypesApi(api_client)
    add_domain_type_request = AddDomainTypeRequest(
        id="id_example",
        name="name_example",
        description="description_example",
        parent_id="parent_id_example",
    ) # AddDomainTypeRequest |  (optional)
...
# **add_domain_types**
> [DomainTypeImpl] add_domain_types()
...
# **change_domain_type**
> DomainTypeImpl change_domain_type(domain_type_id)
...
with collibra_core.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = domain_types_api.DomainTypesApi(api_client)
    domain_type_id = "domainTypeId_example" # str | the unique identifier of the domain type
    change_domain_type_request = ChangeDomainTypeRequest(
        id="id_example",
        name="name_example",
        description="description_example",
        parent_id="parent_id_example",
    ) # ChangeDomainTypeRequest |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Changes the domain type.
        api_response = api_instance.change_domain_type(domain_type_id)
        pprint(api_response)
    except collibra_core.ApiException as e:
...
# **change_domain_types**
> [DomainTypeImpl] change_domain_types()
...
# **find_domain_types**
> DomainTypePagedResponse find_domain_types()
...
with collibra_core.ApiClient(configuration) as api_client:
    ...
    parent_id = "parentId_example" # str | The ID of the parent to find the domain types in. (optional)
    exclude_meta = True # bool | Whether the meta domain types should be excluded from search or not. (optional) if omitted the server will use the default value of True
    top_level = False # bool | Whether only top level domain types should be searched or not. (optional) if omitted the server will use the default value of False
...
> DomainTypePagedResponse find_sub_domain_types(domain_type_id, domain_type_id2)
...
with collibra_core.ApiClient(configuration) as api_client:
    ...
    api_instance = domain_types_api.DomainTypesApi(api_client)
    domain_type_id = "domainTypeId_example" # str | the unique identifier of the domain type
    domain_type_id2 = "domainTypeId_example" # str | The ID of the domain type to search the sub types for.
    include_parent = True # bool | Whether parent domain type should be included in the search result. (optional)

    # example passing only required values which don't have defaults set
    try:
        # Returns sub domain types matching the given search criteria.
        api_response = api_instance.find_sub_domain_types(domain_type_id, domain_type_id2)
        pprint(api_response)
    except collibra_core.ApiException as e:
